...
Download [the mod helper](https://github.com/gurrenm3/BTD-Mod-Helper/releases/latest/download/Btd6ModHelper.dll) and [MelonLoader](https://nightly.link/LavaGang/MelonLoader/actions/runs/6921935783/MelonLoader.Windows.x64.CI.Release.zip)
